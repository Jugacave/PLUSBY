    ...
    <div className="p-4 md:p-6 lg:p-8 max-w-6xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-[#8888A0] text-sm mt-0.5">Configura tu cuenta y preferencias de Plusby</p>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center py-24 gap-6">
        <div className="w-24 h-24 rounded-3xl flex items-center justify-center" style={{ background: "rgba(136,136,160,0.1)" }}>
          <Settings size={40} style={{ color: "#8888A0" }} />
        </div>
        <div className="text-center">
          <h2 className="text-xl font-semibold text-[#F0F0F5]">Settings</h2>

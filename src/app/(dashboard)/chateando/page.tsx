  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-6xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#F0F0F5]">Chateando</h1>
          <p className="text-[#8888A0] text-sm mt-0.5">Chat de soporte y comunidad</p>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center py-24 gap-6">
        ...
        <div className="text-center">
          <h2 className="text-xl font-semibold text-[#F0F0F5]">Chateando</h2>

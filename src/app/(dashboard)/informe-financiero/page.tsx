  ...
  return (
    <div className="p-4 md:p-6 lg:p-8 max-w-6xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-[#F0F0F5]">Informe Financiero</h1>
          <p className="text-[#8888A0] text-sm mt-0.5">Analiza la rentabilidad de tu operación de dropshipping</p>
        </div>
      </div>
      <div className="flex flex-col items-center justify-center py-24 gap-6">
        <div className="w-24 h-24 rounded-3xl flex items-center justify-center" style={{ background: "rgba(16,185,129,0.1)" }}>
          <TrendingUp size={40} style={{ color: "#10B981" }} />
        </div>
        <div className="text-center">
          <h2 className="text-xl font-semibold text-[#F0F0F5]">Informe Financiero</h2>
